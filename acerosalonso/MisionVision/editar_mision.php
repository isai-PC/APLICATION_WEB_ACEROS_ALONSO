...
<body>
    ...
    <main class="admin-detalle">
        ...
        <div class="container2">
            ...
            <form action="guardar_mision.php" method="post" enctype="multipart/form-data">
                <div class="form-section">
                    <label for="mision">Misión:</label>
                    <textarea id="mision" name="mision" rows="8" cols="50" required><?= htmlspecialchars($datos['mision']) ?></textarea>
