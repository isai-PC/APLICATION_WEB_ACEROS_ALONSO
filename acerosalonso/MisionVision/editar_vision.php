...
<body>
    ...
    <main class="admin-detalle">
        ...
        <div class="container2">
            ...
            <form action="guardar_vision.php" method="post" enctype="multipart/form-data">
                <div class="form-section">
                    <label for="vision">Visión:</label>
                    <textarea id="vision" name="vision" rows="8" cols="50" required><?= htmlspecialchars($datos['vision']) ?></textarea>
