...
$reporte = obtenerAsistenciasSuperioresPromedio();
?>
...
<head>
    ...
    <title>Asistencias Superiores al Promedio | Aceros Alonso</title>
...
<body>
    ...
    <main>
        <section class="contenedor-reporte">
            <h1>EMPLEADOS CON MÁS ASISTENCIAS QUE EL PROMEDIO</h1>
            <p style="text-align: center; margin-bottom: 20px;">
                Empleados cuyo total de asistencias supera el promedio general.
            </p>

            <div style="background: #dfe6ed; padding: 20px; border-radius: 8px; border: 1px solid #ccc; text-align: center; margin-bottom: 20px;">
                <h3 style="margin-bottom: 10px; color: #333;">Consultas Rápidas</h3>
                        ...
                        <?php if (!empty($reporte)): ?>
                            <?php foreach ($reporte as $fila): ?>
                                <tr>
                                    ...
                                    <td style="color: #2e8b57; font-weight: bold;">
                                        <?= htmlspecialchars($fila['totalasi']) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
